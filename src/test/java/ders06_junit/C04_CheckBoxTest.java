...
public class C04_CheckBoxTest {
    ...
    public void test01() throws InterruptedException {
        ...
        if(checkBox1.isSelected()){
            System.out.println("checkbox1 is selected, test FAILED");
        }else {
            System.out.println("checkbox1 is not selected, test PASSED");
        }

        if (checkBox2.isSelected()){
            System.out.println("checkbox2 is selected, test PASSED");
        }else{
